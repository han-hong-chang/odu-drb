...
/*modified by joe*/
RlcDrbPmToDuFunc rlcDrbPmOpts[] =
{
   packRlcDuDrbPm,          /* 0 - loosely coupled */
   DuProcRlcDrbMetrics,     /* 1 - tightly coupled */
   packRlcDuDrbPm           /* 2 - LWLC loosely coupled */
};
/*modified by joe*/
/*******************************************************************
 *
...
/*******************************************************************
 *
 * @brief Sends Drb Performance Metrics to DU APP
 *
 * @details
 *
 *    Function : rlcSendDrbPmToDu 
 *
 *    Functionality:  Sends Performace Metrics per drb together to DU APP
 *
 * @params[in] Pst *pst, DrbPmList *drbStats 
 *             
 * @return ROK     - success
 *         RFAILED - failure
 *
 * ****************************************************************/
uint8_t rlcSendDrbPmToDu(Pst *pst, DrbPmList *drbStats)
{
    return (*rlcDrbPmOpts[pst->selector])(pst, drbStats);
}
/*modified by joe*/
/**********************************************************************
         End of file
