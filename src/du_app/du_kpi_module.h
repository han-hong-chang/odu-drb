...
/*modified by joe*/
void kpmStoreDrbRlcMetric(DrbPmList* drbMetricList);
/*modified by joe*/
...
/*modified by joe*/
typedef struct kpmDrbRlcPm
{
  int ThpDl;
}KpmDrbRlcPm;

/*Database for Drb performance metrics*/
typedef struct kpmDrbPmDb
{ 
  
  int numOfRlcPm; // index of stored RLC performace metrics. replaced by indexOfDrbRlcPm, due to memory problem
  int avgThpDl;
  KpmDrbRlcPm eachRlcPm[SIZE_OF_RLCDB]; // perofrmance metrics in RLC
...
/*modified by joe*/
KpmDrbPmDb kpmDrbPmDb; // Store drb performance metrics
/*modified by joe*/
...
/*modified by joe*/
int32_t indicationRlcDrbCount; // Size of stored performace metrics in this interval
int indexOfDrbRlcPm;  // Stored performace metrics in Database
bool kpmDrbIndicationEnable;
/*modified by joe*/
#endif
